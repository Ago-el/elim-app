...
class ApiClient {
  static const baseUrl = 'https://elim-ap.onrender.com';
  ...
  Future<dynamic> put(String path, Map<String, dynamic> body) async {
    final r = await http.put(Uri.parse('$baseUrl$path'), headers: await headers(), body: jsonEncode(body));
    return decode(r);
  }

  Future<dynamic> delete(String path) async {
    final r = await http.delete(Uri.parse('$baseUrl$path'), headers: await headers());
    return decode(r);
  }
